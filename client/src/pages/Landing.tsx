                  ...
                  <div className="flex flex-col md:flex-row items-center justify-center mt-1">
                    ...
                    <div className="flex flex-col justify-center items-center">
                      ...
                      <div className="flex justify-center items-center ">
                        <button
                          className="btn btn-primary text-base rounded-2xl px-11 normal-case bg-primary-orange min-w-min cursor-pointer text-white hover:text-primary-orange border-none shadow"
